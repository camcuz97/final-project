    ...
    def get(self):
        ...
        if not user:
            ...
            if not existing_user:
                ...
                generic_hiphop.put()
                generic_punk = Playlist(genre = genre2.key, mood = "Indifferent", spotify_html = '<iframe src="https://embed.spotify.com/?uri=spotify:user:spotify_france:playlist:0jR0hPAPkEJLg3OGFZ3kyE" width="800" height="470" frameborder="0" allowtransparency="true"></iframe>')
                generic_punk.put()
                ...
                generic_alt.put()
                generic_pop = Playlist(genre = genre4.key, mood = "Indifferent", spotify_html = '<iframe src="https://embed.spotify.com/?uri=spotify:user:spotify:playlist:5FJXhjdILmRA2z5bvz4nzf" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>')
                generic_pop.put()
